...
__conda_setup="$('/home/tangke/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/tangke/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/tangke/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/tangke/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
export `"${NVIDIA_DIR}/init.sh"`
export CUDA_ROOT_DIR=${NVIDIA_DIR}/cuda-11.1
export CUDNN_ROOT_DIR=${NVIDIA_DIR}/cudnn-v8.0.4
export TRT_ROOT_DIR=${NVIDIA_DIR}/TensorRT-7.2.2.3
